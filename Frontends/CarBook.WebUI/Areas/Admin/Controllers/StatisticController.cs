...
namespace CarBook.WebUI.Areas.Admin.Controllers
{
    ...
    public class StatisticController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            //CarCountWithLessThan1000Kilometers
            ...
            //CarCountByFuelGasolineOrDiesel
            ...
            ////CarBrandAndModelByDailyRentPriceMax
            //var valueCarBrandAndModelByDailyRentPriceMax = GetStatisticAsync(client, "GetCarBrandAndModelByDailyRentPriceMax");
            //ViewBag.carBrandAndModelByDailyRentPriceMax = valueBrandCount.Result.result.carBrandAndModelByDailyRentPriceMax;
            //ViewBag.carBrandAndModelByDailyRentPriceMaxRandom = random.Next(0, 101);


            ////CarBrandAndModelByDailyRentPriceMin
